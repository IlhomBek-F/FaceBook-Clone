...
function Header({ responsiveForMobile, popup }) {
  const [{ user }, dispatch] = useStateValue();
  // https://toybraryaustin.com/wp-content/uploads/2021/05/facebook-logo-full-transparent-2048x683.png
  ...
  return (
    <>
      <motion.div
        ...
        className={popup ? "header close" : "header"}
      >
        <div className="header__left">
          {responsiveForMobile ? (
            <img src=" https://toybraryaustin.com/wp-content/uploads/2021/05/facebook-logo-full-transparent-2048x683.png" />
          ) : (
        ...
        <div className="header__center responsive ">
          ...
          <div className={"header__option "}>
            <NavLink exact to="/friends" className="main-nav">
              <svg
                viewBox="0 0 28 28"
                class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 em6zcovv"
                height="28"
          ...
          <div className={"header__option "}>
            <NavLink exact to="/group" className="main-nav">
              <svg
                viewBox="0 0 28 28"
                class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 em6zcovv"
                height="28"
          ...
          <div className={"header__option "}>
            <NavLink exact to="/profile" className="main-nav">
              <svg
                viewBox="0 0 28 28"
                class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 em6zcovv"
                height="28"
        ...
        <div className="header__right responsive">
          <IconButton>
            <AddIcon />
          </IconButton>
          <IconButton>
      ...
      {popup ? (
        ...
        <div className="header__bottom__for__mobile">
          <div className="icons">
